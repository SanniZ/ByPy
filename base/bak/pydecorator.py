    ...
    def get_input_args_decorator(func):
        def get_input_wrapper(*args, **kwargs):
            ...
            if all((func_args['args'], isinstance(func_args['args'], dict))):
                ...
                kwargs['args'] = __get_input_args(func_args['opts'], ordered_args)
            return func(*args, **kwargs)
...
# get_cmd_args
#
# it will get cmd args and run app.
#
# sample function:
# @get_cmd_args('hf:')
...
def get_cmd_args(opts, ordered_args=True):
    def get_cmd_args_decorator(func):
        def get_cmd_args_wrapper(*kargs, **kwargs):
            args = __get_input_args(opts, ordered_args)
            return func(args)
        return get_cmd_args_wrapper
    return get_cmd_args_decorator